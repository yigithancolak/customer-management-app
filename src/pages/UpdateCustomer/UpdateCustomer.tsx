...
import { Check, EditCalendarOutlined } from '@mui/icons-material'
import {
  Button,
  Container,
...
export const UpdateCustomer = () => {
  ...
  //     queryKey: ['getCustomerData', id],
  //     queryFn: () => getCustomerData(id),
                    ...
                    <DateField
                      ...
                      InputProps={{
                        endAdornment: (
                          <IconButton
                            onClick={() =>
                              setIsEditing({ ...isEditing, lastPayment: false })
                            }
                          >
                            <Check />
                          </IconButton>
                    ...
                    <DateField
                      ...
                      InputProps={{
                        endAdornment: (
                          <IconButton
                            onClick={() =>
                              setIsEditing({ ...isEditing, nextPayment: false })
                            }
                          >
                            <Check />
                          </IconButton>
